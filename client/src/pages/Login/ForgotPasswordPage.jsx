  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-10">
      <section className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl shadow-slate-200/60">
        ...
        {submitted ? <div className="mt-6 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-900" role="status">If an account exists, a reset link has been sent. Check your inbox and spam folder.</div> : <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
          <div>
