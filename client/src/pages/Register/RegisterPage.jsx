    ...
    <div className="min-h-screen w-full bg-[#F8FAFC]">
      <div className="flex min-h-screen w-full items-center justify-center px-4 py-10">
        <div className="w-full max-w-[520px]">
          <div className="rounded-[20px] bg-white px-8 py-10 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:px-10">
            ...
            <div className="mt-9 text-center">
              <h1 className="text-[30px] font-bold text-[#172033]">Create your account</h1>
              <p className="mt-2 text-sm text-[#64748B]">Create your account and start managing your restaurant effortlessly.</p>
            </div>

            <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-5">
              <div>
                <label htmlFor="fullName" className="mb-1.5 block text-sm font-medium text-[#172033]">
                  Full Name
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-[56px] w-full rounded-xl border border-[#E2E8F0] bg-white pl-11 pr-4 text-sm text-[#172033] outline-none transition-all placeholder:text-[#94A3B8] focus:border-[#128277] focus:ring-[3px] focus:ring-[#128277]/10"
                    {...register("fullName", {
              ...
              <div>
                <label htmlFor="phone" className="mb-1.5 block text-sm font-medium text-[#172033]">
                  Phone Number
                </label>
                <div className="relative">
                  <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <PasswordInput
                    ...
                    className="h-[56px] w-full rounded-xl border border-[#E2E8F0] bg-white pl-11 pr-10 text-sm text-[#172033] outline-none transition-all placeholder:text-[#94A3B8] focus:border-[#128277] focus:ring-[3px] focus:ring-[#128277]/10"
                    {...register("password", {
              ...
              <div>
                <label htmlFor="confirmPassword" className="mb-1.5 block text-sm font-medium text-[#172033]">
                  Confirm Password
                </label>
                <div className="relative">
                  <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              ...
              <button
                ...
                className="mt-2 flex h-[56px] w-full items-center justify-center rounded-xl bg-[#128277] text-base font-semibold text-white shadow-lg shadow-[#128277]/25 transition-all hover:bg-[#0e6b5f] hover:shadow-xl hover:shadow-[#128277]/30 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-80"
              >
                {isSubmitting ? (
