const EmptyState = ({ icon, title, description, action, className = "" }) => (
  <section className={`rounded-2xl border border-dashed border-slate-300 bg-gradient-to-b from-white to-slate-50/70 p-6 text-center shadow-sm sm:p-8 ${className}`}>
