...
inventorySchema.index({ restaurant: 1, outlet: 1, sku: 1 }, { unique: true, partialFilterExpression: { outlet: { $type: "objectId" } } });
inventorySchema.index({ restaurant: 1, centralKitchen: 1, sku: 1 }, { unique: true, partialFilterExpression: { centralKitchen: { $type: "objectId" } } });
inventorySchema.index({ restaurant: 1, outlet: 1, itemName: 1 });
